...
function Header({ placeholder }) {
  ...
  const handleSelect = (ranges) => {
    //selection refer to the key beware of typo
    ...
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5  md:px-10">
      ...
      <div className="flex items-center py-2 rounded-full md:shadow-sm md:border-2">
        <input
          ...
          className="pl-5 bg-transparent flex-grow text-xs md:text-sm text-gray-600 placeholder-gray-400 outline-none "
          type="text"
      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mx-auto ">
          ...
          <div className="flex items-center border-b mb-4">
            ...
            <input value={noOfGuests} onChange={(e) => setNoOfGuest(e.target.value)} min="1" type="number" className="w-12 pl-2 text-lg outline-none text-red-400" />
          </div>
          <div className="flex">
